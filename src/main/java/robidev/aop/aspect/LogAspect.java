...
public class LogAspect {
    ...
    @Pointcut("target(robidev.aop.service.HelloService)")
    ...
    @Pointcut("execution(* robidev.aop.service.HelloService.*(java.lang.String))")
    ...
    @Pointcut("execution(* robidev.aop.service.*.*(..))")
